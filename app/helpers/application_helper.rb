module ApplicationHelper
  ...
  def get_continent(country_code)
    continents = {
      ...
      :latin_america => ["MX","BB","BZ","CR","CU","DM","DO","SV","GD","GT","AI","AG","AW","BS","BM","VG","KY","GP","HT","HN","JM","MQ","MS","AN","NI","PA","PR","BL","KN","LC","MF","PM","VC","TT","TC","VI","AR","BO","BR","CL","CO","EC","FK","GF","GY","PY","PE","SR","UY","VE"],
      :north_merica => ["US","CA","GL"],
