...
function invite_social_init(){
  ...
  $('.twitter').click(function(){
    ...
    window.open("https://twitter.com/share?url=" + invite_url + "&text= Sign-up on @Advlo_ to help me receive $25 towards an amazing adventure. %23AdventureLocal", 'sharer', 'top=' + (height/3) + ',left=' + (width/3) + ',toolbar=0,status=0,width=' + 500 + ',height=' + 500);
  })
}
