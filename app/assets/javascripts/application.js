...
function footerInit(){
  ...
  $('.question').click(function(){
    ...
    $('.answer-1').last().children().html( ((parseInt($('.answer-1').last().children().html().substring(0,3)) / totalPolls).toFixed(2) * 100) + '%' )
    $('.answer-1').last().prepend($('.answer-1').first().data('poll'))

    $('.answer-2').last().children().html( ((parseInt($('.answer-2').last().children().html().substring(0,3)) / totalPolls).toFixed(2) * 100) + '%' )
    $('.answer-2').last().prepend($('.answer-2').first().data('poll'))

    $('.answer-3').last().children().html( ((parseInt($('.answer-3').last().children().html().substring(0,3)) / totalPolls).toFixed(2) * 100) + '%' )
